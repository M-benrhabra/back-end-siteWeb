                    ...
                    <?php include('errors.php') ?>
                        ...
                        <!-- <div class="row"> -->
                            ...
                            <div class="form-group col-lg-12">
                                <button type="submit" id="contact" name="reg_user" class="btn btn-default">Submit</button>
                            </div>
                            <div class="form-group col-lg-12">
                                <button type="submit" id="contact" class="btn btn-default"><a href="login.php"> Already a user? log in</a></button>
                            </div>
                        <!-- </div> -->
                    </form>
                </div>
